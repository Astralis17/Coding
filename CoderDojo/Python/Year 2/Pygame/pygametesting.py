...
def handlebasemovement(x, y, speed, dashcheck):
    ...
    if not keys[pygame.K_LSHIFT]:
        dashcheck = False
    return x, y, speed, dashcheck

def handleinput( dashtick, dashtickup, dashtickdown, dashtickright, dashtickleft):
    keys = pygame.key.get_pressed()
    ...
    return dashtick, dashtickup, dashtickdown, dashtickright, dashtickleft
...
#General player movement
    playerx, playery, speed, dashcheck = handlebasemovement(playerx, playery, speed, dashcheck)
...
#Bullet Movement
    ...
    if bulletx <= -10 or bulletx >= windowwidth or bullety <= -10 or bullety >= windowheight:
        bullety = playery + 8
        bulletx = playerx + 8
        bulletyspeed = 9000
        bulletxspeed = 9000
...
#All Game Object Drawing
    ...
    #Info Bar
    pygame.draw.rect(window, (0,0,0), (0, windowheight - 50, 1370, 50))#Info Bar
